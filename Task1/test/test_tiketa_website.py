...
class TiketaTest(unittest.TestCase):
    ...
    def setUp(self) -> None:
        with open('/Users/jacobaudu/Desktop/TeleSoftas/Task1/test/config.json') as config_file: 
            self.config = json.load(config_file)
        if self.config.get('browser') == "chrome":
            self.driver = webdriver.Chrome("/Users/jacobaudu/Desktop/TeleSoftas/Task1/drivers/chromedriver")
